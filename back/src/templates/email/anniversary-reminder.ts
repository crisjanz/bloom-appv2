export interface AnniversaryReminderTemplateData {
  firstName: string;
  daysBefore: number;
  shopName: string;
  shopUrl: string;
...
export function buildAnniversaryReminderEmail(data: AnniversaryReminderTemplateData): string {
      ...
      <div style="max-width:600px; margin:0 auto; background:#ffffff; border-radius:14px; overflow:hidden;">
        ...
        <div style="padding:12px 28px 28px; color:#1f2937;">
          ...
          <p style="margin:0 0 20px; font-size:16px; line-height:1.6;">
            Your anniversary ${timing}. Plan something beautiful for the occasion.
          </p>
