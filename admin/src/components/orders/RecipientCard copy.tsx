...
import { GOOGLE_MAPS_API_KEY } from '@/constants/config'; // Adjust path as needed
...
export default function RecipientCard({
  ...
  // Filter shortcuts based on query - FIXED: Removed setFilteredShortcuts from dependencies
  useEffect(() => {
    ...
    <ComponentCard title={orderType === "PICKUP" ? "Pickup Person Information" : "Recipient Information"}>
      ...
      <div className="flex justify-between items-center mt-6">
        ...
        {orderType === "DELIVERY" && customerId && recipientFirstName && recipientAddress.address1 && (
          ...
          >
            {isSaving ? "Saving..." : "Save as New Recipient"}
          </button>
        )}
        ...
        <button
          ...
          className="flex justify-center rounded border border-stroke py-2 px-6 font-medium text-black hover:shadow-1 dark:border-strokedark dark:text-white ml-auto"
        >
