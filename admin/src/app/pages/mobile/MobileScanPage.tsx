  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-50 to-brand-100 dark:from-gray-900 dark:to-gray-800 flex flex-col">
      ...
      <div className="bg-white dark:bg-gray-900 shadow-sm p-4 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-900 dark:text-white">Scan Order</h1>
          <p className="text-xs text-gray-500 dark:text-gray-400">
            Wire orders & web orders
          </p>
        </div>
        <div className={`ml-auto w-10 h-10 ${isFloranext ? 'bg-green-500' : 'bg-brand-500'} rounded-full flex items-center justify-center`}>
      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        {parsedData && !loading && (
          <div className="space-y-6">
            {/* Success Message */}
            <div className={`${isFloranextData ? 'bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800' : 'bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800'} border rounded-2xl p-6 flex items-center gap-4`}>
