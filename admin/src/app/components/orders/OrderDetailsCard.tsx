...
import Radio from "@shared/ui/forms/input/Radio";
...
type OrderSourceType = "phone" | "walkin" | "wirein" | "website" | "pos";
      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <Radio
            ...
            name="orderSource"
            value="wirein"
            checked={orderSource === "wirein"}
            label="Wire-In Order"
            onChange={() => setOrderSource?.("wirein")}
          />
        </div>
